...
data = pd.read_csv("data/small_sample_data.csv",low_memory=False) # Use Sample Data
...
# data = data.groupby('State').apply(lambda x: x.sample(frac=0.2, random_state=42)).reset_index(drop=True)
# data.to_csv("data\small_sample_data.csv")
